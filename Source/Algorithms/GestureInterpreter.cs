...
namespace WesternMichgian.SeniorDesign.KinectProject.Algorithms
{
    public class GestureInterpreter
    {
        ...
        /// <returns> A boolean of whether sufficient hand-flapping has been detected or not. </returns>
        ...
        private int FrequencyBetween(PVPair pvp1, PVPair pvp2)
        {
            ...
            // Get start frame for frequency calculation.
            index = pvp1.frames.Item1;
            passedMidLine = false;
